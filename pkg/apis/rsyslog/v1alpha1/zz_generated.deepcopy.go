...
func (in *AuditRulesConfig) DeepCopyInto(out *AuditRulesConfig) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuditRulesConfig.
func (in *AuditRulesConfig) DeepCopy() *AuditRulesConfig {
	if in == nil {
		return nil
	}
	out := new(AuditRulesConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RsyslogRelpConfig) DeepCopyInto(out *RsyslogRelpConfig) {
	*out = *in
	...
	if in.AuditRulesConfig != nil {
		in, out := &in.AuditRulesConfig, &out.AuditRulesConfig
		*out = new(AuditRulesConfig)
		(*in).DeepCopyInto(*out)
	}
	return
