...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*AuditRulesConfig)(nil), (*rsyslog.AuditRulesConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AuditRulesConfig_To_rsyslog_AuditRulesConfig(a.(*AuditRulesConfig), b.(*rsyslog.AuditRulesConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*rsyslog.AuditRulesConfig)(nil), (*AuditRulesConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_rsyslog_AuditRulesConfig_To_v1alpha1_AuditRulesConfig(a.(*rsyslog.AuditRulesConfig), b.(*AuditRulesConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AuditRulesConfig_To_rsyslog_AuditRulesConfig(in *AuditRulesConfig, out *rsyslog.AuditRulesConfig, s conversion.Scope) error {
	out.Enabled = (*bool)(unsafe.Pointer(in.Enabled))
	out.ConfigMapReferenceName = (*string)(unsafe.Pointer(in.ConfigMapReferenceName))
	return nil
}

// Convert_v1alpha1_AuditRulesConfig_To_rsyslog_AuditRulesConfig is an autogenerated conversion function.
func Convert_v1alpha1_AuditRulesConfig_To_rsyslog_AuditRulesConfig(in *AuditRulesConfig, out *rsyslog.AuditRulesConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_AuditRulesConfig_To_rsyslog_AuditRulesConfig(in, out, s)
}

func autoConvert_rsyslog_AuditRulesConfig_To_v1alpha1_AuditRulesConfig(in *rsyslog.AuditRulesConfig, out *AuditRulesConfig, s conversion.Scope) error {
	out.Enabled = (*bool)(unsafe.Pointer(in.Enabled))
	out.ConfigMapReferenceName = (*string)(unsafe.Pointer(in.ConfigMapReferenceName))
	return nil
}

// Convert_rsyslog_AuditRulesConfig_To_v1alpha1_AuditRulesConfig is an autogenerated conversion function.
func Convert_rsyslog_AuditRulesConfig_To_v1alpha1_AuditRulesConfig(in *rsyslog.AuditRulesConfig, out *AuditRulesConfig, s conversion.Scope) error {
	return autoConvert_rsyslog_AuditRulesConfig_To_v1alpha1_AuditRulesConfig(in, out, s)
}
...
func autoConvert_v1alpha1_RsyslogRelpConfig_To_rsyslog_RsyslogRelpConfig(in *RsyslogRelpConfig, out *rsyslog.RsyslogRelpConfig, s conversion.Scope) error {
	...
	out.AuditRulesConfig = (*rsyslog.AuditRulesConfig)(unsafe.Pointer(in.AuditRulesConfig))
	return nil
}
...
func autoConvert_rsyslog_RsyslogRelpConfig_To_v1alpha1_RsyslogRelpConfig(in *rsyslog.RsyslogRelpConfig, out *RsyslogRelpConfig, s conversion.Scope) error {
	...
	out.ResumeRetryCount = (*int)(unsafe.Pointer(in.ResumeRetryCount))
	out.ReportSuspensionContinuation = (*bool)(unsafe.Pointer(in.ReportSuspensionContinuation))
	out.AuditRulesConfig = (*AuditRulesConfig)(unsafe.Pointer(in.AuditRulesConfig))
	return nil
}
