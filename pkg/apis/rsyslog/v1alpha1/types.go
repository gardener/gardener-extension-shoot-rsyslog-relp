...
type RsyslogRelpConfig struct {
	...
	// Filters contain the filters that will be used to determine when to call
	// the rsyslog log forwarding action.
	// +optional
	...
	// +optional
	ResumeRetryCount *bool `json:"resumeRetryCount,omitempty"`
