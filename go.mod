...
require (
	...
	github.com/gardener/repo-tools v0.0.0-20260318150621-8be4fbe79f1b
	github.com/gardener/repo-tools/hack/tools/logcheck v0.0.0-20260318134821-db3d34486ef2
