...
//go:generate find . -not ( -name *managedresources.yaml -or -name *clusters.yaml -or -name *extensions.yaml -or -name *prometheusrules.yaml -or -name *scrapeconfigs.yaml -or -name doc.go ) -delete
