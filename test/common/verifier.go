...
// ExpectedAuditRules is a set of expected audit rules to be deployed on the shoot nodes
// when the AuditConfig in the shoot-rsyslog-relp extension providerConfig is enabled and
// does not specify a ConfigMap reference containing custom audit rules.
const ExpectedAuditRules = `## This file is automatically generated from /etc/audit/rules.d
-D
-b 8192
-f 1
