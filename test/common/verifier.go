...
// ExpectedAuditRules are the expected audit rules. Exposed so that they can be modified by tests.
var ExpectedAuditRules = `## This file is automatically generated from /etc/audit/rules.d
-D
-b 8192
-f 1
...
func (v *Verifier) verifyThatAuditRulesAreInstalled(ctx context.Context) {
	EventuallyWithOffset(2, func(g Gomega) {
		...
		g.Expect(string(response)).To(Equal(ExpectedAuditRules), fmt.Sprintf("Expected the /etc/audit/audit.rules file to contain correct audit rules on node %s", v.nodeName))
